    ...
    <header className="fixed-top bg-white px-4 py-4 shadow-sm">
      <div className={`container ${styles.headerBar}`}>
        ...
        <nav className="d-none d-md-flex gap-4">
          ...
          <a href="https://koeuro.shop/" target="_blank" rel="noopener noreferrer" className={styles.koeuromall}>
            코유로 몰
          </a>
        ...
        <Button variant="outline-secondary" className="d-md-none" onClick={toggleMenu}>
          Toggle navigation
        </Button>
      </div>
    </header>
